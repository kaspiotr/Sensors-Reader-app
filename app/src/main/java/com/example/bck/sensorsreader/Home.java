    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch(id) {
            ...
            case R.id.nav_accelerometer:
                Intent accelerometerIntent = new Intent(Home.this, Accelerometer.class);
                startActivity(accelerometerIntent);
                break;
            case R.id.nav_magnetometer:
                Intent magnetometerIntent = new Intent(Home.this, Magnetometer.class);
                startActivity(magnetometerIntent);
                break;
            case R.id.nav_light:
                Intent lightIntent = new Intent(Home.this, Light.class);
